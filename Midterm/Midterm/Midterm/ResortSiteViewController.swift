//
//  ResortSiteViewController.swift
//  Midterm
//
...
class ResortSiteViewController: UIViewController, UIWebViewDelegate {
    ...
    func loadWebPage(_ urlString: String){
        ...
        let item0 = URL(string: urlString)
        //create a URLRequest object
        let request = URLRequest(url: item0!)
